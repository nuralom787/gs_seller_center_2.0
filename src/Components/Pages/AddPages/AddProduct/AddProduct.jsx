                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <div className="px-6 pt-8 flex-grow w-full h-full max-h-full">
                            ...
                            <div className="grid grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                                ...
                                <div className="col-span-8 sm:col-span-4">
                                    <input
                                        {...register("sku", { required: "* This field must have some value!!" })}
                            ...
                            <div className="grid grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                                ...
                                <div className="col-span-8 sm:col-span-4">
                                    <input {...register("slug", { required: "* This field must have some value!!" })} className="w-full p-3 text-base rounded-md border border-gray-400 focus:border-gray-700 dark:border-gray-500 dark:focus:border-gray-100 bg-gray-100 dark:bg-gray-900 text-[#151515] dark:text-white outline-0" type="text" placeholder="Product slug" />
                            ...
                            <div className="grid grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                                ...
                                <div className="col-span-8 sm:col-span-4">
                                    <textarea {...register("description", { required: "* This field must have some value!!" })} className="w-full p-3 text-base rounded-md border border-gray-400 focus:border-gray-700 dark:border-gray-500 dark:focus:border-gray-100 bg-gray-100 dark:bg-gray-900 text-[#151515] dark:text-white outline-0" placeholder="Product details" rows="4" spellCheck="false">
                                    </textarea>
                            ...
                            <div className="grid grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                                ...
                                <div className="col-span-8 sm:col-span-4">
                                    <select {...register("parent", { required: "* This field must have some value!!" })} className="w-full p-3 text-base rounded-md border border-gray-400 focus:border-gray-700 dark:border-gray-500 dark:focus:border-gray-100 bg-gray-100 dark:bg-gray-900 text-[#151515] dark:text-white outline-0">
                            ...
                            <div className="grid grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                                ...
                                <div className="col-span-8 sm:col-span-4">
                                    <select {...register("children", { required: "* This field must have some value!!" })} className="w-full p-3 text-base rounded-md border border-gray-400 focus:border-gray-700 dark:border-gray-500 dark:focus:border-gray-100 bg-gray-100 dark:bg-gray-900 text-[#151515] dark:text-white outline-0">
                            ...
                            <div className="grid grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                                ...
                                <div className="col-span-8 sm:col-span-4">
                                    <select {...register("type", { required: "* This field must have some value!!" })} className="w-full p-3 text-base rounded-md border border-gray-400 focus:border-gray-700 dark:border-gray-500 dark:focus:border-gray-100 bg-gray-100 dark:bg-gray-900 text-[#151515] dark:text-white outline-0">
                            ...
                            <div className="grid grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                                ...
                                <div className="col-span-8 sm:col-span-4">
                                    <input {...register("unit", { required: "* This field must have some value!!" })} className="w-full p-3 text-base rounded-md border border-gray-400 focus:border-gray-700 dark:border-gray-500 dark:focus:border-gray-100 bg-gray-100 dark:bg-gray-900 text-[#151515] dark:text-white outline-0" type="text" placeholder="Unit" />
                            ...
                            <div className="grid grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                                ...
                                <div className="col-span-8 sm:col-span-4">
                                    <input {...register("quantity", { required: "* This field must have some value!!" })} className="w-full p-3 text-base rounded-md border border-gray-400 focus:border-gray-700 dark:border-gray-500 dark:focus:border-gray-100 bg-gray-100 dark:bg-gray-900 text-[#151515] dark:text-white outline-0" type="number" placeholder="Quantity" />
                            ...
                            <div className="grid grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                                ...
                                <div className="col-span-8 sm:col-span-4">
                                    <input {...register("originalPrice", { required: "* This field must have some value!!" })} className="w-full p-3 text-base rounded-md border border-gray-400 focus:border-gray-700 dark:border-gray-500 dark:focus:border-gray-100 bg-gray-100 dark:bg-gray-900 text-[#151515] dark:text-white outline-0" type="number" placeholder="Price" />
                            ...
                            <div className="grid grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                                ...
                                <div className="col-span-8 sm:col-span-4">
                                    <input {...register("price", { required: "* This field must have some value!!" })} className="w-full p-3 text-base rounded-md border border-gray-400 focus:border-gray-700 dark:border-gray-500 dark:focus:border-gray-100 bg-gray-100 dark:bg-gray-900 text-[#151515] dark:text-white outline-0" type="number" placeholder="Sale price" />
