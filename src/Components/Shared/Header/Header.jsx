...
const Header = ({ handleDrawer }) => {
    ...
    const currentStaff = staffs?.staffs?.find(staff => staff.email === user.email);
                    ...
                    <li>
                        <div className="dropdown dropdown-end">
                            <div
                                tabIndex={0}
                                role="button"
                                className="cursor-pointer rounded-full dark:bg-gray-500 bg-white text-white h-8 w-8 font-medium mx-auto"
                                data-tooltip-id="my-tooltip"
                            ...
                            >
                                <div className="relative rounded-full inline-block w-8 h-8 align-middle" aria-hidden="true">
                                    {currentStaff ?
                                        <img className="object-cover w-8 h-8 rounded-full" src={currentStaff?.photoURL} alt='' />
                                        :
                                        <img className="object-cover w-8 h-8 rounded-full" src={defaultUser} alt='' />
                                    }
                                </div>
                            </div>
                            <ul tabIndex={0} className="dropdown-content menu bg-white dark:bg-gray-800 ring-1 ring-black ring-opacity-5 rounded-box z-1 w-52 shadow-sm">
                                <li className="font-serif font-medium my-2 transition-colors hover:bg-gray-200 text-gray-500 hover:text-green-500 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-gray-200">
                                    <NavLink to="/" onClick={() => setDrop(false)}>
                                        <span className="flex items-center gap-3 text-base">
                                            <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 512 512" className="w-5 h-5" aria-hidden="true" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><rect width="176" height="176" x="48" y="48" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="32" rx="20" ry="20"></rect><rect width="176" height="176" x="288" y="48" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="32" rx="20" ry="20"></rect><rect width="176" height="176" x="48" y="288" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="32" rx="20" ry="20"></rect><rect width="176" height="176" x="288" y="288" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="32" rx="20" ry="20"></rect>
                                            </svg>
                                            <span className='font-bold font-sans'>Dashboard</span>
                                        </span>
                                    </NavLink>
                                </li>
                                <li className="font-serif font-medium my-2 transition-colors hover:bg-gray-200 text-gray-500 hover:text-green-500 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-gray-200">
                                    <NavLink to="/user/profile" onClick={() => setDrop(false)}>
                                        <span className="flex items-center gap-3 text-base">
                                            <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 512 512" className="w-5 h-5" aria-hidden="true" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="32" d="M262.29 192.31a64 64 0 1057.4 57.4 64.13 64.13 0 00-57.4-57.4zM416.39 256a154.34 154.34 0 01-1.53 20.79l45.21 35.46a10.81 10.81 0 012.45 13.75l-42.77 74a10.81 10.81 0 01-13.14 4.59l-44.9-18.08a16.11 16.11 0 00-15.17 1.75A164.48 164.48 0 01325 400.8a15.94 15.94 0 00-8.82 12.14l-6.73 47.89a11.08 11.08 0 01-10.68 9.17h-85.54a11.11 11.11 0 01-10.69-8.87l-6.72-47.82a16.07 16.07 0 00-9-12.22 155.3 155.3 0 01-21.46-12.57 16 16 0 00-15.11-1.71l-44.89 18.07a10.81 10.81 0 01-13.14-4.58l-42.77-74a10.8 10.8 0 012.45-13.75l38.21-30a16.05 16.05 0 006-14.08c-.36-4.17-.58-8.33-.58-12.5s.21-8.27.58-12.35a16 16 0 00-6.07-13.94l-38.19-30A10.81 10.81 0 0149.48 186l42.77-74a10.81 10.81 0 0113.14-4.59l44.9 18.08a16.11 16.11 0 0015.17-1.75A164.48 164.48 0 01187 111.2a15.94 15.94 0 008.82-12.14l6.73-47.89A11.08 11.08 0 01213.23 42h85.54a11.11 11.11 0 0110.69 8.87l6.72 47.82a16.07 16.07 0 009 12.22 155.3 155.3 0 0121.46 12.57 16 16 0 0015.11 1.71l44.89-18.07a10.81 10.81 0 0113.14 4.58l42.77 74a10.8 10.8 0 01-2.45 13.75l-38.21 30a16.05 16.05 0 00-6.05 14.08c.33 4.14.55 8.3.55 12.47z">
                                            </path>
                                            </svg>
                                            <span className='font-bold font-sans'>Edit Profile</span>
                                        </span>
                                    </NavLink>
                                </li>
                                <li className="cursor-pointer font-serif font-medium my-2 transition-colors hover:bg-gray-200 text-gray-500 hover:text-green-500 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-gray-200">
                                    <button onClick={LogoutUser} className='w-full cursor-pointer'>
                                        <span className="flex items-center gap-3 text-base">
                                            ...
                                            <span className='font-bold font-sans'>Log out</span>
                                        </span>
                                    </button>
                                </li>
                            </ul>
